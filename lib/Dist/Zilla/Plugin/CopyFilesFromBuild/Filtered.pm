...
# ABSTRACT: Copy *.PL from build dir to root dir
...
distribution root.  May be given multiple times.
...
This module copies files from the build directory to the root directory,
but filters out lines from the copied file.  It is designed in particular
for generated *.PL files, which often have unwanted "generated by" tags that
cause unwanted file churn.
